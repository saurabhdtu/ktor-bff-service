...
set CLASSPATH=%APP_HOME%\lib\bff.jar

@rem Execute com.zinc.money.bff
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %COM_ZINC_MONEY_BFF_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%COM_ZINC_MONEY_BFF_EXIT_CONSOLE%" exit 1
exit /b 1
